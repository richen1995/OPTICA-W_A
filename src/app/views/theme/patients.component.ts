  ...
  private procederConGuardado() {
    ...
    const fullVisit: MedicalRecordExtended = {
      ...
      refractions: this.hasValue(refData) ? [{
        ...
        id_medical_record: this.idMedicalRecord || 0,
        ref_sph_cyl_ax_dym_od: refData.od.ref_sph_cyl_ax_dym_od,
        ref_sph_cyl_ax_dym_oi: refData.oi.ref_sph_cyl_ax_dym_oi,
        ref_sph_cyl_ax_stat_od: refData.od.ref_sph_cyl_ax_stat_od,
        ref_sph_cyl_ax_stat_oi: refData.oi.ref_sph_cyl_ax_stat_oi,
